    ...
    function getCandybirdDefaultSheetSources() {
        return [
            'products' => [
                ...
                'optional_headers' => ['additional_categories', 'discount', 'discounted_price', 'discount_valid_from', 'discount_valid_until', 'product_type', 'qty_in_stock', 'lead_time', 'slug', 'homepage_featured', 'shipping_weight', 'free_delivery_excluded', 'disclaimers', 'pricelist_sort'],
            ],
            'coupons' => [
                'label' => 'Coupons',
