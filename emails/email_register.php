...
<table width="100%" style="background-color: #6b0099; color: #ffffff;" cellpadding="20">
    <tr>
        ...
        <td align="right" style="padding-right: 20px;">
            <h3 style="font-size: 30px; font-weight: bold; color: #FCB42F; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">Welcome!</h3>
        </td>
    </tr>
</table>
<!-- Rope Div -->
...
<table width="100%" cellpadding="30" style="font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff;">
    <tr>
        <td>
            ...
            Welcome to CandyBird! We're thrilled to have you as a part of our community.
            </p>
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">
            With your CandyBird account, you now have access to a personalized dashboard where you can manage your orders, track shipments, and explore our extensive product catalog. Whether you're looking to make a one-time purchase or establish a long-term wholesale relationship, we've got you covered!
            </p>
        </td>
    </tr>
</table>
