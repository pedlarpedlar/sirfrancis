    ...
    <tr>
        <td>
            ...
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">
                You are receiving this email because you subscribed to Sir Francis trade and product updates.
            </p>
            <div style="margin: 20px; padding: 18px; border: 2px dashed #28364B; background-color: #fffaf2; text-align: center;">
                <p style="font-size: 13px; line-height: 1.6; margin: 0 0 8px; color: #333;">{coupon_offer}</p>
                <div style="font-size: 26px; font-weight: bold; color: #28364B; letter-spacing: 1px; margin: 8px 0;">{coupon_code}</div>
            ...
            <p style="text-align: center; margin: 20px 0;">
                <a href="https://sirfrancis.co.za/unsubscribe?email={user_email_unsubscribe}" style="font-size: 12px; font-weight: bold; color: #CEBD88; text-decoration: none; padding: 10px 20px; display: inline-block; border-radius: 0; background-color: #28364B;">
                    Unsubscribe here
                </a>
            ...
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">
                Thank you for staying connected with Sir Francis.
            </p>
        </td>
    </tr>
</table>
    ...
    <tr>
        <td align="center">
          <ul style="list-style: none; padding: 0; margin: 0;">
            ...
            <li style="font-size:10px; display: inline-block; color: white;"> <span style="padding-left:5px;padding-right: 5px;">&#8226;</span> <a href="https://sirfrancis.co.za/products" style="text-decoration: none; color: #28364B; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">Products</a></li>
          </ul>
      </td>
  </tr>
    ...
    <tr>
        <td align="center" style="padding: 20px;">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center">
                        <a href="https://www.facebook.com/marinecollagenSA" style="margin-right: 10px;"><img src="https://sirfrancis.co.za/assets/img/emails/fb_icon.png" alt="Facebook" width="30"></a>
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                        <a href="https://sirfrancis.co.za" target="_blank"><img src="https://sirfrancis.co.za/assets/img/emails/x_icon.png" alt="Website" width="30"></a>
                    </td>
                </tr>
            </table>
        </td>
