...
<table width="100%" cellpadding="30" style="font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff;">
        ...
        <td>
            ...
            A user has just subscribed on our platform. For backup purposes, their email address is:
            </p>
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">
            {user_email}
            </p>
...
<table width="100%" style="background-color: #F1F0E8;color:#28364B;" cellpadding="20">
    <tr>
        <td align="center">
            <h4 style="font-size: 18px; font-weight: bold; color: #28364B; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">Sir Francis Admin Notice</h4>
