        ...
        <tfoot>
            ...
            <tr>
                ...
                <th style="padding: 10px; border: none;text-align: right;">
                    <a href="https://sirfrancis.co.za/admin-sf/order_details?order_id={order_id}" target="_blank" style="font-size: 12px; font-weight: bold; color: #CEBD88; text-decoration: none; padding: 10px 20px; display: inline-block; border-radius: 0; background-color: #28364B;">View Printable Order</a>
                </th>
            </tr>
        </tfoot>
    </table>
