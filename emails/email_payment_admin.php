...
<table width="100%" cellpadding="30" style="font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff;">
    <tr>
        <td>
            <h1 style="font-size: 16px; font-weight: bold; margin-bottom: 20px; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">Hi Admin,</h1>
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">
            You received a payment of {order_total} for order {order_id}.
            </p>
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">
            It's time to carefully pack & prepare this order for shipping. Reach out to {client_name} at {client_email} or {client_number}.
            </p>
        </td>
    </tr>
</table>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <th style="padding: 10px; border: none;text-align: right;">
                    <a href="https://www.fishgelatine.co.za/v2/admin-sf/order_details?order_id={order_id}" target="_blank" style="font-size: 12px; font-weight: bold; color: #CEBD88; text-decoration: none; padding: 10px 20px; display: inline-block; border-radius: 0; background-color: #28364B;">View Printable Order</a>
                </th>
            </tr>
        </tfoot>
    </table>
