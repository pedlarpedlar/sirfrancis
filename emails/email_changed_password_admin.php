...
<table width="100%" style="background-color: #6b0099; color: #ffffff;" cellpadding="20">
    <tr>
        ...
        <td align="right" style="padding-right: 20px;">
            <h3 style="font-size: 30px; font-weight: bold; color: #FCB42F; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">User Successfully Changed Password</h3>
        </td>
    </tr>
</table>
<!-- Rope Div -->
...
<table width="100%" cellpadding="30" style="font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff;">
        ...
        <td>
            ...
            A user has successfully reset their password. Updated code: {special_code}
            </p>            
        </td>
    </tr>
</table>
...
<table cellspacing="0" cellpadding="10" bgcolor="#F1F0E8" style="margin-top: 30px; padding: 15px; border-radius: 0;">
    <tr>
        <td align="center">
            <a href="https://www.candybird.co.za/admin-cb/users?id={user_id}" target="_blank" style="font-size: 12px; font-weight: bold; color: #FCB42F; text-decoration: none; padding: 10px 20px; display: inline-block; border-radius: 0; background-color: #6b0099;">View User</a>
        </td>
    </tr>
    <tr>
        <td>
...
<!-- Footer Section -->
<table width="100%" style="background-color: #F1F0E8;#6b0099;" cellpadding="20">
    <tr>
        <td align="center">
