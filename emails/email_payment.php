...
<table width="100%" style="background-color: #6b0099; color: #ffffff;" cellpadding="20">
    <tr>
        ...
        <td align="right" style="padding-right: 20px;">
            <h3 style="font-size: 30px; font-weight: bold; color: #FCB42F; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">Payment Confirmation</h3>
        </td>
    </tr>
</table>
<!-- Rope Div -->
