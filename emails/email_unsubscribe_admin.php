...
<table width="100%" style="background-color: #28364B; color: #ffffff;" cellpadding="20">
    <tr>
        ...
        <td align="right" style="padding-right: 20px;">
            <h3 style="font-size: 30px; font-weight: bold; color: #CEBD88; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">User Unsubscribed</h3>
        </td>
    </tr>
</table>
<!-- Rope Div -->
