...
<table width="100%" style="background-color: #6b0099; color: #ffffff;" cellpadding="20">
    <tr>
        ...
        <td align="right" style="padding-right: 20px;">
            <h3 style="font-size: 30px; font-weight: bold; color: #FCB42F; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">Payment Failed</h3>
        </td>
    </tr>
</table>
<!-- Rope Div -->
...
<table width="100%" cellpadding="30" style="font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff;">
    <tr>
        <td>
            ...
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">
            We have not received your payment. If you think this was an error, kindly send an email to sales@candybird.co.za
            </p>
        </td>
    </tr>
</table>
    ...
    <table class="table table-bordered table-striped" style="width: 100%; border-collapse: collapse; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff; text-align: left;">
        <thead>
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 1px solid #ccc;">{payment_method} <a href="https://www.candybird.co.za/order_details?order_id={order_id}" target="_blank" style="font-size: 12px; font-weight: bold; color: #FCB42F; margin-left:30px; text-decoration: none; padding: 10px 20px; display: inline-block; border-radius: 0; background-color: green;">Pay Now</a></td>
            </tr>
        </thead>
    </table>
</div>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <th style="padding: 10px; border: none;text-align: right;">
                    <a href="https://www.candybird.co.za/order_details?order_id={order_id}" target="_blank" style="font-size: 12px; font-weight: bold; color: #FCB42F; text-decoration: none; padding: 10px 20px; display: inline-block; border-radius: 0; background-color: #6b0099;">Manage Order</a>
                </th>
            </tr>
        </tfoot>
    </table>
