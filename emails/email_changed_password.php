...
<table width="100%" cellpadding="30" style="font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff;">
    <tr>
        <td>
            ...
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">Your password has been successfully updated. If you did not initiate this change, please <a href="https://sirfrancis.co.za/contact">contact us immediately</a>.</p>
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">You can now <a href="https://sirfrancis.co.za/login">login to your account</a> using your updated credentials.</p>
