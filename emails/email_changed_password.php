...
<table width="100%" style="background-color: #6b0099; color: #ffffff;" cellpadding="20">
    <tr>
        ...
        <td align="right" style="padding-right: 20px;">
            <h3 style="font-size: 30px; font-weight: bold; color: #FCB42F; font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal;">Password Changed Successfully</h3>
        </td>
    </tr>
</table>
<!-- Rope Div -->
...
<table width="100%" cellpadding="30" style="font-family:'Montserrat', sans-serif;font-optical-sizing: auto;font-weight: 400;font-style: normal; background-color: #ffffff;">
    <tr>
        <td>
            ...
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">Your password has been successfully updated. If you did not initiate this change, please <a href="https://www.candybird.co.za/contact">contact us immediately</a>.</p>
            <p style="font-size: 14px; line-height: 1.6; padding: 0 20px;">You can now <a href="https://www.candybird.co.za/login">login to your account</a> using your updated credentials.</p>
