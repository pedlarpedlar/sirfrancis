...
<style>
    ...
    .customer-profile-hero h1 { color: #fcb42f; margin-bottom: 6px; }
    ...
    .customer-profile-card h2 { color: #5b1178; font-size: 20px; margin-bottom: 12px; }
    ...
    .customer-profile-table th { color: #5b1178; font-size: 12px; text-transform: uppercase; }
