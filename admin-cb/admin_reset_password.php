...
<style>
    .admin-reset-card { background:#fff; border:1px solid #eadfd2; border-radius:8px; box-shadow:0 12px 28px rgba(44,41,38,.08); margin:35px auto; max-width:460px; padding:28px; }
