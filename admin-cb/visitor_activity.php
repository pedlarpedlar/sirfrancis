...
<style>
    ...
    .visitor-hero h1 { color: #fcb42f; font-size: 26px; margin: 0 0 6px; }
    ...
    .visitor-orders a { background: #f7f0fb; border-radius: 999px; color: #5b1178; font-weight: 800; padding: 5px 10px; }
