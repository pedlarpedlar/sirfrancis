...
<head>
    ...
    <title>Receipt <?= cbReceiptText($displayOrderId) ?> - CandyBird</title>
    <style>
...
<body>
    ...
    <main class="receipt">
        <img class="logo" src="<?= cbReceiptText($receiptLogoSrc) ?>" alt="CandyBird">
        ...
        <hr>
        <p class="footer">
            Thank you for shopping with CandyBird.<br>
            www.candybird.co.za
        </p>
    </main>
