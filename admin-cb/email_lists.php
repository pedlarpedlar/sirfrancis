...
<title>Email Lists - CandyBird Admin</title>
...
<style>
    ...
    .email-list-hero h1 { color: #fcb42f; font-size: 28px; margin: 0 0 6px; }
    .email-list-panel { background: #fff; border: 1px solid #e9e2d8; border-radius: 8px; padding: 18px; height: 100%; }
    .email-list-panel h2, .email-list-panel h3 { color: #5b1178; }
            ...
            <div class="email-list-panel">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="field-help">For example: Wholesale leads June, Eid gifting clients, PE walk-in buyers.</div>
                    </div>
                    <div class="form-group">
