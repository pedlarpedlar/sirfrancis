    ...
    if (mysqli_num_rows($resultCart) == 0) {
        ...
        if (isset($_SESSION['coupon'])) {
            ...
            $_SESSION['coupon'] = array_merge($_SESSION['coupon'], [
                ...
                'category_restriction' => $checkoutCoupon['category_restriction'] ?? $checkoutCoupon['category_restrictions'] ?? $checkoutCoupon['valid_categories'] ?? '',
                'product_type_exclusion' => $checkoutCoupon['product_type_exclusion'] ?? $checkoutCoupon['product_type_exclusions'] ?? $checkoutCoupon['excluded_product_types'] ?? '',
                'product_id_restriction' => $checkoutCoupon['product_id_restriction'] ?? $checkoutCoupon['product_id_restrictions'] ?? $checkoutCoupon['valid_product_ids'] ?? '',
