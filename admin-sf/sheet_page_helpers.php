...
if (!function_exists('cbAdminSheetTemplateRows')) {
    function cbAdminSheetTemplateRows($key) {
        ...
        $explainers = [
            ...
            'additional_categories' => 'Optional extra category paths where this same product should also show. Use Parent > Child and separate multiple paths with |. Example: Gym & Fitness > Seeds | Gifting > Healthy Gifts',
            'name' => 'Product name without size, e.g. Plain Cashews.',
            'price' => 'Normal price before discounts. Use numbers only.',
            'img_url' => 'Direct image URL. For multiple images, separate with commas. Upload your images to your website or any public sharing platform and copy the url.',
        ...
        foreach ($headers as $header) {
            ...
            if ($key === 'products') {
                $examples = [
                    ...
                    'child_category_2' => '',
                    'additional_categories' => 'Gym & Fitness > Seeds | Gifting > Healthy Gifts',
                    'name' => 'Plain Cashews',
                    'price' => '145.00',
                    'img_url' => 'https://www.fishgelatine.co.za/v2/assets/img/product/1.png',
                    'size' => '100g',
                    'discount' => '',
                    'discounted_price' => '',
                    'discount_valid_from' => '',
