...
$subject = trim((string) ($_POST['subject'] ?? 'A message from Sir Francis'));
$heading = trim((string) ($_POST['email_heading'] ?? 'A message from Sir Francis'));
...
function updateCustomerEmailPreview() {
    ...
    var heading = $('#emailHeading').val() || 'A message from Sir Francis';
